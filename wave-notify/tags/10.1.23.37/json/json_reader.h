...
*/
      ...
      /** \brief Get the amount of characters parsed from the input stream
       * \return \c number of characters read from the input stream
       */
      size_t parsedInput() { return ( lastValueEnd_ == NULL ? current_ : lastValueEnd_ ) - begin_; }
